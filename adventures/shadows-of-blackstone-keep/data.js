...
window.RPG_HELPER.adventures.push({
  ...
  intro:
    'The adventure begins immediately. The players arrive at the edge of Oakhollow. Smoke chokes the sky, throwing the looming sunset into crimson shadows. Houses crackle in flames as villagers flee down the dirt roads.',
  objectives: [
  ...
  scenes: [
    {
      ...
      readAloud:
        'Smoke chokes the sky above Oakhollow, throwing the looming sunset into crimson shadows. Houses crackle in flames as villagers flee down the dirt roads. Between the burning storefronts, goblins dart — a raiding party, organized and quick.',
      environment:
